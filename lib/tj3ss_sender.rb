...
class Tj3SsSender
  ...
  def processArguments(argv)
    ...
    opts.banner += <<'EOT'
This program can be used to out status sheets templates via email. It
will generate status sheet templates for managers of the project. The
...
EOT
  ...
  def main
    ...
    ts = TaskJuggler::StatusSheetSender.new('tj3ss_sender')
