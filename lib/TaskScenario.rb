#
# TaskScenario.rb - The TaskJuggler3 Project Management Software
#
...
class TaskScenario < ScenarioData
  ...
  # Computer the turnover generated by this Task for a given Account _account_
  # during the specified TjTime _period_. If a Resource _resource_ is given,
  # only the turnover directly generated by the resource is taken into
  # account. _includeSub_ determines wheter sub tasks should be included as
  # well or not.
  def turnover(startIdx, endIdx, account, resource = nil)
    ...
    if @property.container?
      ...
      # compute the resource related cost.
