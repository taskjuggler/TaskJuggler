...
* Powerful and flexible filtering functions to provide the right amount of detail to the right audience
...
like {these}[http://www.taskjuggler.org/tj3/examples/Overview.html]
from such a {project
...
Please see {this page}[http://www.taskjuggler.org/forum.php] for
...
If you think that you have found a bug in the software, please the
the {bug reporting
